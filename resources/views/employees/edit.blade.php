            ...
            <form action="{{ route('employees.update', $employee->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <input type="text" name="emailid" class="form-control" value="{{$employee->emailid}}"/>
                </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <input type="text" name="doj" class="form-control" value="{{$employee->doj}}"/>
                </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <input type="text" name="division" class="form-control" value="{{$employee->division}}"/>
                </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <input type="text" name="description" class="form-control" value="{{$employee->description}}"/>
                </div>
                    <div class="form-group">
                     <label for="status">STATUS</label>
                     <input type="text" name="status" class="form-control" value="{{$employee->status}}"/>
                </div>
